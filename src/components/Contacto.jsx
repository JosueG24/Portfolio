...
export default function Contacto() {
  return (
    <section className=' txtMd p-5 bg-black text-white w-full h-auto'>
    <p className='w-full h-h-[calc(7vh)] flexAllCenter'>Contacto</p>
    <div className="w-full scrollEfect">
        <div className='flexAllCenter flex-wrap w-full h-[calc(72vh)] flex-col border-b-2 border-c_White'>
