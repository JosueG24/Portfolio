        ...
        <form className='flexAllCenter w-full h-full flex-col border-b-2 border-c_Ebony txtLg' onSubmit={handleSubmit}>
          <div className="flexAllCenter flex-col w-full h-2/10">
            <div className='w-2/3 h-full rounded-lg p-1 flexAllCenter'>
              <input type="text" name="name" placeholder="Ingrese su Nombre" className="placeholder:text-c_Mischka h-full w-8/10 shadow-md shadow-c_Ebony rounded-lg bg-c_Purple border-b-2 border-c_Ebony focus:outline-none text-center"/>
            </div>
            <div className='w-2/3 h-full rounded-lg p-1 flexAllCenter'>
              <input type="text" name="email" placeholder="Ingrese su Correo" className="placeholder:text-c_Mischka h-full w-8/10 shadow-md shadow-c_Ebony rounded-lg bg-c_Purple border-b-2 border-c_Ebony focus:outline-none text-center"/>
            </div>
          </div>
          <div className=' w-2/3 h-6/10 rounded-lg p-2'>
            <textarea className="placeholder:text-c_Mischka border-y-2 border-c_Ebony rounded-lg bg-c_Purple w-full h-full shadow-lg shadow-c_Ebony focus:outline-none p-2" name="textarea" placeholder="Escriba su mensage"></textarea>
          </div>
